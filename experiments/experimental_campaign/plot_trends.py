...
for idx, file_path in enumerate(file_paths):
    ...
    for i in range(3):
        ...
        axes[i].tick_params(axis='both', which='major', labelsize=18)  # Increase size for major ticks
    ...
    axes[3].tick_params(axis='both', which='major', labelsize=18)  # Increase size for major ticks
...
fig.legend(lines, labels, loc='lower center', ncol=len(file_paths), fontsize=20, frameon=False)
