...
# List of file paths
file_paths = [
    "experiment1/follow_teaching.csv",
    "experiment3/follow_teaching.csv",
    "experiment4/follow_trajectory.csv",
    "experiment5/follow_trajectory.csv",
    "experiment6/follow_trajectory.csv",
    "experiment7/follow_trajectory.csv"
]
...
# Prepare headers and summary statistics (removed theta and standard deviation columns)
headers = [
    r"$\textbf{Test}$",
